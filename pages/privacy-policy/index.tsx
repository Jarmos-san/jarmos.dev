...
import styles from "../../pages/license/license.module.scss";

function LicensePage() {
  return (
    <>
      <Head>
        <title>Privacy Policy | Somraj Saha</title>
        <meta property="og:url" content="https://jarmos.vercel.app" />
        <meta property="og:title" content="Privacy Policy | Somraj Saha" />
        <meta
          property="og:description"
          content="Privacy policy of Somraj Saha's personal website."
        />
        <meta
          property="og:image"
        ...
        <meta name="twitter:title" content="Privacy Policy | Somraj Saha" />
        <meta
      ...
      <article className={styles.container}>
        ...
        <p>
          ...
          guidelines. That said, if you concerned about what sort of private
        ...
        <ul>
          <li>
            ...
            collect information directly from you when you share your email with
            us to join our private email list(s). We also collect information if
            you share a feedback or ask us a question through phone or email.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <strong>We Use Information for Security Concerns</strong>: We may
            use information to protect our company, our readers, or our
            websites.
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            : We share information with vendors who help us manage our email
            list subscription process. Some vendors may be located outside of
            India.
          </li>
          <li>
            <strong>
          ...
          <li>
            ...
            : We will tell you before we do this along with a detailed
        ...
        <p>
          ...
          also post an updated copy on our website which you will find on the
