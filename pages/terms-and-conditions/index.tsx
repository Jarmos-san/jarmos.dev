...
function TermsAndConditionsPage() {
  return (
    <>
      <Head>
        <title>Terms & Conditions | Somraj Saha</title>
        <meta property="og:url" content="https://jarmos.vercel.app" />
        <meta property="og:title" content="Terms & Conditions | Somraj Saha" />
        <meta
          property="og:description"
          content="Terms & conditions for using Somraj Saha's personal website."
        />
        <meta
          property="og:image"
        ...
        <meta name="twitter:title" content="Terms & Conditions | Somraj Saha" />
        <meta
      ...
      <article className={styles.container}>
        ...
        <p>
          <strong>
            ...
            WEBSITE, SUBSRIBING TO OUR PRODUCTS AND/OR USING OUR SERVICES FROM
            THIS WEBSITE YOU AGREE TO BE BOUND BY ALL OF THE TERMS AND
        ...
        <p>
          ...
          <Link href="/">jarmos.vercel.app</Link> (the &quot;
          <strong>Website</strong>&quot;), business name (&quot;
          <strong>Somraj Saha</strong>&quot;) offer of services and/or products
          for purchase and/or subscription on this Website, or your purchase of
          products and/or subscriptions available on this Website. This
          Agreement includes, and incorporates by this reference, the policies
          and guidelines referenced below. Somraj Saha reserves the right to
          ...
          Somraj Saha will alert you that changes or revisions have been made by
          indicating on the top of this Agreement the date it was last revised.
          The changes or revised Agreement will be effective immediately after
          it is posted on this Website. Your use of the Website following the
          posting any such changes or of a revised Agreement will constitute
          your acceptance of any such changes or revisions. Somraj Saha
          ...
          or conditions of any other written agreement you may have with Somraj
          Saha for other products or services. If you do not agree to this
        ...
        <p>
          ...
          &quot;<strong>Products</strong>&quot;). By placing an order for
          Products through this Website, you agree to the terms and conditions
          set forth in this Agreement.
        </p>

        <p>
          <strong>Reader Solicitation</strong>: Unless you notify Somraj Saha,
          while they are communicating with you, of your desire to opt out from
        ...
        <p>
          <strong>Sales Tax</strong>. If you purchase any Products and/or
          Services, you will be responsible for paying any applicable sales tax
          (<em>if any</em>).
        </p>
        <h2>II. Website</h2>
        <p>
          ...
          Information Technology (IT). Somraj Saha does not always create the
          information offered on this Website; instead the information is often
          gathered from other sources. To the extent that Somraj Saha does
          ...
          you. Somraj Saha does not endorse the contents on any such third-party
          websites. Somraj Saha is not responsible for the content of or any
        ...
        <p>
          Use of Website; Somraj Saha is not responsible for any damages
        ...
        <p>
          ...
          . You may copy, reproduce, transmit, distribute, or create derivative
          works of such content or information with/without express written
        ...
        <p>
          ...
          Somraj Saha a perpetual, worldwide, non-exclusive, royalty-free,
          ...
          assign such content in any form, in all media now known or hereinafter
          created, anywhere in the world. You are solely responsible for your
          interactions with other users of the Website and any content they
          share with you. Somraj Saha is not liable for any damage or harm
          resulting from any posts by or interactions between users. Somraj Saha
          ...
          Somraj Saha deems objectionable, in Somraj Saha&apos;s sole
          discretion.
        </p>
        <h2>III. Disclaimer of Warranties</h2>
        <p>
          YOUR USE OF THIS WEBSITE AND/OR PRODUCTS ARE AT YOUR SOLE RISK. THE
          WEBSITE AND PRODUCTS ARE OFFERED ON AN &quot;<strong>AS IS</strong>
          &quot; AND &quot;<strong>AS AVAILABLE</strong>&quot; BASIS. SOMRAJ
          SAHA EXPRESSLY DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS
          OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF
          MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT
          WITH RESPECT TO THE PRODUCTS OR WEBSITE CONTENT, OR ANY RELIANCE UPON
          OR USE OF THE WEBSITE CONTENT OR PRODUCTS. (&quot;
          <strong>PRODUCTS&quot; INCLUDE TRIAL PRODUCTS</strong>.)
        </p>
        <p>
          WITHOUT LIMITING THE GENERALITY OF THE FOREGOING, SOMRAJ SAHA MAKES NO
          WARRANTY:
        </p>
        <p>
        ...
        <p>
          SOMRAJ SAHA ENTIRE LIABILITY, AND YOUR EXCLUSIVE REMEDY, IN LAW, IN
          EQUITY, OR OTHWERWISE, WITH RESPECT TO THE WEBSITE CONTENT AND
          PRODUCTS AND/OR FOR ANY BREACH OF THIS AGREEMENT IS SOLELY LIMITED TO
          THE AMOUNT YOU PAID, LESS SHIPPING AND HANDLING, FOR PRODUCTS AND/OR
          SERVICES PURCHASED VIA THE WEBSITE.
        </p>
        <p>
          SOMRAJ SAHA WILL NOT BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL,
        ...
        <p>
          You will release, indemnify, defend and hold harmless Somraj Saha, and
          any of his contractors, agents, employees, officers, directors,
          ...
          supplied to Somraj Saha. When Somraj Saha is threatened with suit or
          sued by a third party, Somraj Saha may seek written assurances from
          you concerning your promise to indemnify Somraj Saha; your failure to
          provide such assurances may be considered by Somraj Saha to be a
          material breach of this Agreement. Somraj Saha will have the right to
          ...
          Somraj Saha&apos;s choice at its expense. Somraj Saha will reasonably
          cooperate in any defense by you of a third-party claim at your request
          and expense. You will have sole responsibility to defend Somraj Saha
          against any claim, but you must receive Somraj Saha a prior written
          consent regarding any related settlement. The terms of this provision
          will survive any termination or cancellation of this Agreement or your
          use of the Website or Products.
        </p>
        <h2>VI. Privacy</h2>
        <p>
          Somraj Saha believes strongly in protecting user privacy and providing
          you with notice of Somraj Saha&apos;s blog&apos;s use of data. Please
          refer to Somraj Saha&apos;s{" "}
          <Link href="/privacy-policy">Privacy Policy</Link>, incorporated by
        ...
        <p>
          ...
          Services, you acknowledge that you have read and agree to be bound by
          this Agreement and all terms and conditions on this Website.
        </p>
        <h2>VIII. General</h2>
        <p>
        ...
        <p>
          ...
          between you and Somraj Saha and supersedes any prior agreements
          pertaining to the subject matter contained herein.
        </p>
        <p>
          Effect of Waiver. The failure of Somraj Saha to exercise or enforce
        ...
        <p>
          ...
          This Agreement will be governed by the laws of the State of India
          without regard to its conflict of law principles to the contrary.
          Neither you nor Somraj Saha will commence or prosecute any suit,
          proceeding or claim to enforce the provisions of this Agreement, to
          recover damages for breach of or default of this Agreement, or
          otherwise arising under or by reason of this Agreement, other than in
          courts located in State of India. By using this Website or ordering
          and/or subscribing to our Products, you consent to the jurisdiction
          and venue of such courts in connection with any action, suit,
          proceeding or claim arising under or by reason of this Agreement. You
          hereby waive any right to trial by jury arising out of this Agreement
        ...
        <p>
          Termination. Somraj Saha reserves the right to terminate your access
          to the Website if it reasonably believes, in its sole discretion, that
          you have breached any of the terms and conditions of this Agreement.
          Following termination, you will not be permitted to use the Website
          and Somraj Saha may, in its sole discretion and without advance notice
          to you, cancel any outstanding orders for Products. If your access to
          the Website is terminated, Somraj Saha reserves the right to exercise
          whatever means it deems necessary to prevent unauthorized access of
          the Website. This Agreement will survive indefinitely unless and until
          Somraj Saha chooses, in its sole discretion and without advance to
          you, to terminate it.
        </p>
        <p>
