...
const TermsAndConditionsPage = () => {
  return (
    <article
      className="container mx-auto max-w-screen-sm space-y-4 px-5
      text-white-10 lg:max-w-screen-md xl:max-w-screen-lg 2xl:max-w-screen-xl"
    >
      ...
      <p>
        <strong>
          ...
          THIS WEBSITE YOU AGREE TO BE BOUND BY ALL OF THE TERMS AND CONDITIONS
          OF THIS AGREEMENT.
        </strong>
      </p>
      ...
      <p>
        ...
        products and/or subscriptions available on this Website. This Agreement
        includes, and incorporates by this reference, the policies and
        guidelines referenced below. Somraj Saha reserves the right to change or
        revise the terms and conditions of this Agreement at any time by posting
        any changes or a revised Agreement on this Website. Somraj Saha will
        alert you that changes or revisions have been made by indicating on the
        top of this Agreement the date it was last revised. The changes or
        ...
        such changes or revisions. Somraj Saha encourages you to review this
        ...
        written agreement you may have with Somraj Saha for other products or
      ...
      <h2 className="font text-xl font-extrabold text-green-10">I. Products</h2>

      <p>
        Terms of Offer. This Website offers for sale certain products (the
        &quot;<strong>Products</strong>&quot;). By placing an order for Products
        through this Website, you agree to the terms and conditions set forth in
        this Agreement.
      </p>
      ...
      <p>
        ...
        <ol className="ml-9 list-outside list-disc leading-loose">
          <li>
      ...
      <p>
        ...
        and trade secrets in the Products &amp; Services mentioned in this
      ...
      <h2 className="font text-xl font-extrabold text-green-10">II. Website</h2>
      ...
      <p>
        ...
        through indirect links to third-party websites, about Information
        Technology (IT). Somraj Saha does not always create the information
        offered on this Website; instead the information is often gathered from
        other sources. To the extent that Somraj Saha does create the content on
        this Website, such content is protected by intellectual property laws of
        the India, foreign nations, and international bodies. Unauthorized use
        of the material may violate copyright, trademark, and/or other laws. You
        ...
        provided solely as a convenience to you. Somraj Saha does not endorse
        the contents on any such third-party websites. Somraj Saha is not
        responsible for the content of or any damage that may result from your
        access to or reliance on these third-party websites. If you link to
      ...
      <p>
        ...
        or indirectly, in transmission of &quot;spam&quot;, chain letters, junk
      ...
      <p>
        ...
        Website under the Terms &amp; Conditions laid down by{" "}
        <a
          href="https://creativecommons.org/licenses/by-nc/4.0/legalcode"
          target="_blank"
          className="underline underline-offset-4 hover:text-green-10"
      ...
      <p>
        ...
        content in any form, in all media now known or hereinafter created,
        anywhere in the world. You are solely responsible for your interactions
        with other users of the Website and any content they share with you.
        Somraj Saha is not liable for any damage or harm resulting from any
        posts by or interactions between users. Somraj Saha reserves the right,
        but has no obligation, to monitor interactions between and among users
        of the Website and to remove any content Somraj Saha deems
        objectionable, in Somraj Saha&apos;s sole discretion.
      </p>
      ...
      <p>
        ...
        &quot; AND &quot;<strong>AS AVAILABLE</strong>&quot; BASIS. SOMRAJ SAHA
        ...
        USE OF THE WEBSITE CONTENT OR PRODUCTS. (&quot;
      ...
      <p>
        ...
        YOU PAID, LESS SHIPPING AND HANDLING, FOR PRODUCTS AND/OR SERVICES
      ...
      <p>
        ...
        to Somraj Saha. When Somraj Saha is threatened with suit or sued by a
        third party, Somraj Saha may seek written assurances from you concerning
        your promise to indemnify Somraj Saha; your failure to provide such
        assurances may be considered by Somraj Saha to be a material breach of
        this Agreement. Somraj Saha will have the right to participate in any
        defense by you of a third-party claim related to your use of any of the
        Website content or Products, with counsel of Somraj Saha&apos;s choice
        at its expense. Somraj Saha will reasonably cooperate in any defense by
        you of a third-party claim at your request and expense. You will have
        sole responsibility to defend Somraj Saha against any claim, but you
        must receive Somraj Saha a prior written consent regarding any related
      ...
      <h2 className="font text-xl font-extrabold text-green-10">VI. Privacy</h2>
      ...
      <p>
        ...
        you and Somraj Saha and supersedes any prior agreements pertaining to
      ...
      <p>
        ...
        located in State of India. By using this Website or ordering and/or
        subscribing to our Products, you consent to the jurisdiction and venue
        of such courts in connection with any action, suit, proceeding or claim
        arising under or by reason of this Agreement. You hereby waive any right
      ...
      <p>
        ...
        Somraj Saha may, in its sole discretion and without advance notice to
        you, cancel any outstanding orders for Products. If your access to the
        Website is terminated, Somraj Saha reserves the right to exercise
        ...
        Somraj Saha chooses, in its sole discretion and without advance to you,
        to terminate it.
      </p>
