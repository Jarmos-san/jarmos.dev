...
const description = `Terms & conditions of using Somraj Saha's personal website`;
...
const TermsAndConditionsPage = () => {
  return (
    ...
    >
      ...
      <h2 className="my-4 text-xl font-extrabold text-green-10">I. Products</h2>
      ...
      <h2 className="my-4 text-xl font-extrabold text-green-10">II. Website</h2>
      ...
      <h2 className="my-4 text-xl font-extrabold text-green-10">
      ...
      <h2 className="my-4 text-xl font-extrabold text-green-10">VI. Privacy</h2>
