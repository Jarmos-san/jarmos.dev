...
const description = `Privacy policy for using Somraj Saha's personal website`;
...
const LicensePage = () => {
  return (
    ...
    >
      ...
      <address className="bg-slate-700 p-4">
        <span className="block">Mr. Somraj Saha,</span>
        <span className="block">Calcutta Textiles, Masjid Road</span>
        <span className="block">Agartala, West Tripura,</span>
        <span className="block">Tripura, India</span>
        <span className="block">PIN: 799001</span>
        <span className="block">Email: contact@jarmos.dev</span>
        <span className="block">
          Phone: (+91) 7731 824 653 | (+91) 8794 891 882
        </span>
      </address>
