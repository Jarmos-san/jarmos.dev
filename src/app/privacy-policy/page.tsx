  ...
  return (
    ...
    >
      ...
      <p>
        ...
        every step of developing this website, we ensured everything is covered
        under the{" "}
        <a
        ...
        guidelines. That said, if you concerned about what sort of private data
        do we collect, this section of the website contains everything you will
        need to read about.
      </p>

      <h2 className="mb-6 text-xl font-extrabold text-green-10">
        Information We Collect
      </h2>

      <ul className="ml-9 list-outside list-decimal leading-loose">
        <li>
        ...
        <li>
          ...
          information about you. These information might include your age, your
          residence, country, gender, specific preferences for content &amp; so
          on. They are collected through use of third-party trackers like Google
          Analytics, Cloudflare Analytics &amp; Twitter Analytics. We might
          collect this as a part of a survey also.
        </li>
        <li>
          <strong>Other Information</strong>: If you use our website, we may
          collect information about your IP address and the browser you are
          using. We might look at what site you came from, duration of time
      ...
      <ul className="ml-9 list-outside list-decimal leading-loose">
        <li>
          ...
          information directly from you when you share your email with us to
          join our private email list(s). We also collect information if you
          share a feedback or ask us a question through phone or email.
        </li>
        <li>
          <strong>We Collect Information From You Passively</strong>: We use
          tracking tools like Google Analytics, Google Webmaster, Cloudlfare
          Analytics, Twitter Analytics, browser cookies and web beacons for
      ...
      <ul className="ml-9 list-outside list-decimal leading-loose">
        <li>
          ...
          subscription on our website or for other promotional purposes.
        </li>
        <li>
          <strong>
        ...
        <li>
          <strong>We Use Information for Security Concerns</strong>: We may use
          information to protect our company, our readers, or our websites.
        </li>
        <li>
          ...
          interesting. Or, for example, posts containing affiliate links &amp;
          other sponsored posts. Do note, you will be notified of the nature of
          the posts when we send you one.
        </li>
        <li>
          <strong>
      ...
      <ul className="ml-9 list-outside list-decimal leading-loose">
        <li>
          ...
          : We share information with vendors who help us manage our email list
        ...
        <li>
          <strong>
            We Will Share Information If We Think We Have to Comply With or to
            Protect Ourselves
          </strong>
        ...
        <li>
          ...
          : For example, if part of our business is sold we may give our reader
        ...
        <li>
          ...
          : We will tell you before we do this along with a detailed explanation
          for us to do so.
        </li>
      </ul>
      ...
      <p>
        ...
        you received. There will be an unsubscribe option at the bottom of it.
        Do note, even if you opt out of getting marketing messages, we will
        still be sending you transactional messages through email about your
        purchase of our goods &amp; services.
      </p>
      ...
      <address className="bg-slate-900 p-3">
        <span className="block">Somraj Saha,</span>
        <span className="block">
          2nd Floor, Above Ram Thakur Tubewells, Masjid Road
        </span>
        <span className="block">Agartala, Tripura</span>
        <span className="block">PIN: 799001</span>
        <span className="block">Phone: (+91) 7731 824 653</span>
        <span className="block">
          Email:{" "}
          <a
      ...
      <p>
        ...
        telephone or whichever means is convenient for you. Please do so without
        any hesitation.
      </p>
      ...
      <p>
        ...
        also post an updated copy on our website which you will find on the top
        of this Privacy Policy document. Please check our site periodically for
        updates.
      </p>
