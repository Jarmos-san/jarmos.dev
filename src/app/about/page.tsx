...
const description = `Somraj Saha is a Senior Software Engineer working
...
const AboutPage = () => (
  ...
  >
    ...
    <p>
      ...
      businesses of all scale solve some of their business problems using my
      software engineering skills. And when I am not doing business I contribute
      (or even create) opensource tools as a hobby and recreational purposes.
      The website you are on right now is where I share my knowledge, skills and
      thoughts as a Software Engineer.
    </p>
    ...
    <p>
      Although I use quite a few frameworks and libraries on a daily basis, I am
      listing only a few of the primary and most widely used ones here. I am
    ...
    <p>
      A Software Engineer without his tools is &ldquo;
      <i>a Batman without his Batsuit/Batmobile</i>&rdquo;, hence it is very
      important for me to choose and maintain a bunch of tools I would use on a
      day-to-day basis to write code as well.
    </p>
    ...
    <ol className="ml-9 list-outside list-decimal leading-loose">
      <li>
        ...
        (<i>through Windows Subsytem for Linux 2</i>) and{" "}
        <a
        ...
        (<i>planning</i>) for development at certain times.
      </li>
      <li>
        <a
      ...
      <li>
        ...
        configure and setup a &ldquo;
        <a
          href="https://youtu.be/QMVIJhC9Veg?si=PjcDowVBq34iFopC"
          target="_blank"
          className="underline underline-offset-4 hover:text-green-10"
        >
          <i>Personalised Development Environment (PDE)</i>
        </a>
        &rdquo;, check out{" "}
        <a
